 ...
 */
object NativeVisitList_bak_20200730 {
      ...
      val bxData = dstream
        ...
        .map(v => {
          ...
          (
            ...
            properties.getOrElse("v1_message_id",""),
            properties.getOrElse("v1_custom_params",""),
            properties.getOrElse("wx_openid",""),
            properties.getOrElse("wx_uid",""),
            properties.getOrElse("v1_lcs_name",""),
            properties.getOrElse("v1_source",""),
            properties.getOrElse("v1_lcs_id",""),
            properties.getOrElse("v1_invest_id",""),
            properties.getOrElse("v1_element_title",""),
            properties.getOrElse("v1_element_type",""),
            properties.getOrElse("v1_is_push",""),
            properties.getOrElse("v1_push_type",""),
            properties.getOrElse("v1_is_live",""),
            properties.getOrElse("event",v._1),
            properties.getOrElse("v1_push_title",""),
            properties.getOrElse("v1_page_url","")
